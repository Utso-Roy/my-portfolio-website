...
const Navbar = () => {
  ...
  return (
    <div className=" my-4">
      <div className="navbar fixed backdrop-blur-lg max-w-5xl mx-auto z-1000 bg-base-80 rounded-[10px] shadow-lg ">
  ...
  <div className="ring-primary ring-offset-base-100 w-8 rounded-full ring ring-offset-2">
    <img src="https://i.ibb.co.com/6061VMNC/Utso-Roy.jpg" />
  </div>
</div>
                  </div>
        </div>
